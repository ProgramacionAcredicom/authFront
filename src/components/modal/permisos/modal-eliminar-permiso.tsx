...
import { AppWindow, KeyRound, LetterText, Trash2, X } from "lucide-react";
import { useState } from "react";
import { useFormPermisosEliminar } from "@/hooks/formularios/permisos/useFormPermisos";
...
export const ModalEliminarPermiso = () => {
  ...
  const { form, onSubmit } = useFormPermisosEliminar(permiso, setOpen, id);
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value}>
                    <FormControl>
                      <SelectTrigger className="w-full rounded-full" startContent={<AppWindow className="size-4" />} disabled>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea {...field} startContent={<LetterText className="size-4" />} disabled />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
